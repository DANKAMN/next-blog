        ...
        <div className='max-w-2xl mx-auto p-3 text-center'>
          <div>
            ...
            <div className='text-md text-gray-500 flex flex-col gap-6'>
              <p>
                Welcome to Techno Blog! Created by Daniel Nicholas, this blog
                serves as a personal platform to share his insights and ideas with
                the world. Daniel is an enthusiastic developer who enjoys writing
              ...
              <p>
                ...
                engineering, and programming languages. Daniel is continually
